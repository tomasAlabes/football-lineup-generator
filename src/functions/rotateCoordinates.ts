 ...
 */
export function rotateCoordinates90CCW(
...
export function rotatePlayerCoordinates90CCW(
  playersWithCoords: Array<{ player: PlayerPositioning; coordinates: FieldCoordinates }>,
  originalWidth: number,
  originalHeight: number
): Array<{ player: PlayerPositioning; coordinates: FieldCoordinates }> {
