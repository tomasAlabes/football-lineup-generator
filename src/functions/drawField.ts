export function drawField(
  ...
  // Right penalty area
  ctx.strokeRect(
    width - fieldMargin - penaltyWidth + offsetX,
    height / 2 - penaltyHeight / 2,
    penaltyWidth,
    penaltyHeight
  );
  ...
  // Right goal area
  ctx.strokeRect(
    width - fieldMargin - goalAreaWidth + offsetX,
    height / 2 - goalAreaHeight / 2,
    goalAreaWidth,
    goalAreaHeight
  );
